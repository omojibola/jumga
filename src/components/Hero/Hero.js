    ...
    <>
      <Hero1>
        <HeroCover>
          <HeroText>
            <HeroHeading>
              Holiday Sales, <HeadingSpan>Best Deals of the Season</HeadingSpan>
            </HeroHeading>
            <HeroParagraph>
              Get up to 60% off from now till January 31st on amazing cloth
              sales
            </HeroParagraph>
            <Wrapper>
      ...
      <Features>
        <FeatureItem>
          ...
          <FeatureBox>
            ...
            <FeatureP>
              Smooth and fast delivery to your doorstep at cheap rates
            </FeatureP>
          </FeatureBox>
        </FeatureItem>
        <FeatureItem>
